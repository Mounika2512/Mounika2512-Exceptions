...
public class Lab {
    ...
    public void mustThrow()  throws Exception{
        // This method does not contain any code, but it is declared to throw FileNotFoundException
        // So when this method is called, it will throw a FileNotFoundException.
